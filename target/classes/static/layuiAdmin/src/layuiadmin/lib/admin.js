layui.define(['view', 'table'], function (exports) {
    var $ = layui.jquery
        ...
        , SHOW = 'layui-show', HIDE = 'layui-hide', THIS = 'layui-this', DISABLED = 'layui-disabled'
        ...
        , admin = {
            ...
            , error: view.error
            , loading: function () {
                return layer.load(2, {time: 10 * 1000});
            }
            ...
            , tabsBodyChange: function (index, options) {
                ...
                // setTimeout(function () {
                //     admin.tabsBody(index).find('.layadmin-iframe')[0].contentWindow.location.href = options.url;
                // }, 0);
            }
