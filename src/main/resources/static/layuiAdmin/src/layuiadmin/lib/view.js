    ...
    view.req = function (options) {
        ...
        return $.ajax($.extend({
            ...
            , success: function (res) {
                ...
                if (res[response.statusName] == statusCode.ok || res[response.statusName] == statusCode.err || res[response.statusName] == statusCode.errParam) {
                ...
                if (0 === res[response.statusName]) {
                    typeof success === "function" && success(res[response.dataName], res[response.msgName])
                } else if (1 === res[response.statusName]) {
                    typeof options.error === "function" && options.error(res[response.msgName])
                }
                //------
            }
